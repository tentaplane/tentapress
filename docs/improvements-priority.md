...
- Progress log:
  ...
  - 2026-02-01: Added a right‑side block details panel and page outline for quick navigation.
  - Next: Refine inline editing focus (Notion‑style quick insert) and add keyboard shortcuts.
