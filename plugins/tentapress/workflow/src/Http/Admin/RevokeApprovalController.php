...
final class RevokeApprovalController
{
    ...
    {
        try {
            $manager->revokeApproval($resourceType, $resourceId, $this->actor());
        ...
        return $this->redirectToResource($resourceType, $resourceId, 'Approval revoked.');
    }
}
