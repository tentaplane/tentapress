...
final class UpdateController
{
    public function __invoke(
        ...
        try {
            $basePath = $basePathValidator->assertAvailable((string) $data['base_path'], (int) $contentType->id);
        ...
        $contentType->update([
            ...
            'archive_enabled' => $request->boolean('archive_enabled', false),
        ...
        return to_route('tp.content-types.edit', ['contentType' => $contentType->id])
            ->with('tp_notice_success', 'Content type updated.');
    }
