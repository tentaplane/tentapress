...
- Edit media screen uses a 50/50 desktop split with details/actions shown before the form
...
- Edit screen: 50/50 desktop split with details/actions on the left and metadata form on the right.
