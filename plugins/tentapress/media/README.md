...
- Pagination controls in both list and grid media views (top + bottom)
...
- Media index: grid + list with previews, type, size, actions, and pagination links at top and bottom.
