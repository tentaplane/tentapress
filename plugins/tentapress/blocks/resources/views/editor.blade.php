                                                                    ...
                                                                    <div class="flex flex-wrap items-center justify-between gap-2">
                                                                        ...
                                                                        <div class="flex items-center gap-1 text-xs">
                                                                            <button
                                                                                type="button"
                                                                                class="tp-button-link inline-flex items-center justify-center rounded-full p-1 text-slate-500 hover:text-slate-700"
                                                                                :title="repeaterIsCollapsed(index, field.key, rowIndex) ? 'Expand' : 'Collapse'"
                                                                                :aria-label="repeaterIsCollapsed(index, field.key, rowIndex) ? 'Expand row' : 'Collapse row'"
                                                                                @click="repeaterToggleCollapse(index, field.key, rowIndex)"
                                                                                >
                                                                                <svg x-show="repeaterIsCollapsed(index, field.key, rowIndex)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
                                                                                </svg>
                                                                                <svg x-show="!repeaterIsCollapsed(index, field.key, rowIndex)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 9V4.5M9 9H4.5M9 9 3.75 3.75M9 15v4.5M9 15H4.5M9 15l-5.25 5.25M15 9h4.5M15 9V4.5M15 9l5.25-5.25M15 15h4.5M15 15v4.5m0-4.5 5.25 5.25" />
                                                                                                                ...
                                                                                                                <div class="flex flex-wrap items-center justify-between gap-2">
                                                                                                                    ...
                                                                                                                    <div class="flex items-center gap-1 text-xs">
                                                                                                                        <button
                                                                                                                            type="button"
                                                                                                                            class="tp-button-link inline-flex items-center justify-center rounded-full p-1 text-slate-500 hover:text-slate-700"
                                                                                                                            :title="nestedRepeaterIsCollapsed(index, field.key, childIndex, childField.key, rowIndex) ? 'Expand' : 'Collapse'"
                                                                                                                            :aria-label="nestedRepeaterIsCollapsed(index, field.key, childIndex, childField.key, rowIndex) ? 'Expand row' : 'Collapse row'"
                                                                                                                            @click="nestedRepeaterToggleCollapse(index, field.key, childIndex, childField.key, rowIndex)"
                                                                                                                            >
                                                                                                                            <svg x-show="nestedRepeaterIsCollapsed(index, field.key, childIndex, childField.key, rowIndex)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                                                                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
                                                                                                                            </svg>
                                                                                                                            <svg x-show="!nestedRepeaterIsCollapsed(index, field.key, childIndex, childField.key, rowIndex)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                                                                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 9V4.5M9 9H4.5M9 9 3.75 3.75M9 15v4.5M9 15H4.5M9 15l-5.25 5.25M15 9h4.5M15 9V4.5M15 9l5.25-5.25M15 15h4.5M15 15v4.5m0-4.5 5.25 5.25" />
